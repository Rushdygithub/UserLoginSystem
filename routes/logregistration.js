...
const {authonticationMiddleware,tokenVerified} = require('../customMiddleware/middleware')
...
router.post('/create/product', tokenVerified, (req,res)=> {
    let data = req.body
    return apiResponse(req,res,false,'success',200,data)
})
